...
buyer1_buys_1_computer_from_seller2 = CartProduct.create(cart: buyer1_cart, product: computer, quantity: 1)

buyer1_buys_11_books_from_seller3 = CartProduct.create(cart: buyer1_cart, product: book, quantity: 11)

seller2_buys_1_chocolate_bar_from_seller3 = CartProduct.create(cart: seller2_cart, product: chocolate_bar, quantity: 1)
